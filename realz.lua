...
mainFrame.Size = UDim2.new(0, 300, 0, 400) -- Сделал меню поуже
...
local function createSlider(tab, labelText, minVal, maxVal, defaultVal)
	...
	slider.FocusLost:Connect(function()
		...
		if val and val >= minVal and val <= maxVal then
			...
			if humanoid then
				if labelText:find("WalkSpeed") then
					humanoid.WalkSpeed = val
				elseif labelText:find("JumpPower") then
...
-- Unified Content
createSlider(contentFrame, "🏃‍♂️ WalkSpeed", 16, 300, 100)
